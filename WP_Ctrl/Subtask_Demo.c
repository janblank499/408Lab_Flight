...
/*****************************************************************************************/
const int16_t work_waypoints_table[2][32]={//2021年32点
{0,1,1,2,2,3,3,4,5,6,7,7,6,5,4,4,5,6,7,7,6,5,4,4,5,6,7,7,6,5,4,0},//等效东方向
{0,4,5,5,4,4,5,5,5,5,5,4,4,4,4,3,3,3,3,2,2,2,2,1,1,1,1,0,0,0,0,0}//等效北方向
};
...
const int16_t deliver_work_waypoints_table[4][12]={//以起落点为原点
